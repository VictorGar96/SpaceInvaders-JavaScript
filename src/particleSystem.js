...
class Particle
{
    ...
    Draw (ctx) {
        ...
        // bajamos la escala para ajustarlo al tamaño de playership
        ctx.scale(this.scale / 8, this.scale / 8);
...
class ParticleSystem {
    ...
    constructor (maxParticleCount = 100) {
        ...
        this.MIN_INITIAL_SCALE = 0.000001;
        this.MAX_INITIAL_SCALE = 0.000005;
